<div class="modal-body p-4 bg-light">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-9 ps-4">
					...
					<div class="row small mt-3">
						...
						<div class="col-6 mb-2">
							<label class="fw-bold text-muted d-block small">
								<i class="bi bi-calendar-event me-1"></i> NASCIMENTO
							</label>
	...
	<div class="card border-0 mb-4 shadow-sm">
		<div class="card-header bg-white fw-bold border-0 pt-3">
			<i class="bi bi-geo-alt-fill text-danger me-2"></i>Endereço Registrado
		</div>
			...
			<?php if(!empty($membro['membro_endereco_rua'])): ?>
				<p class="mb-0 text-dark">
					...
					<?php if(!empty($membro['membro_endereco_complemento'])): ?>
						<br><span class="text-muted small">Comp: <?= htmlspecialchars($membro['membro_endereco_complemento']) ?></span>
					<?php endif; ?>

					<br><span><?= htmlspecialchars($membro['membro_endereco_bairro'] ?: 'Bairro não informado') ?></span>

					<br><span><?= htmlspecialchars($membro['membro_endereco_cidade']) ?> - <?= $membro['membro_endereco_estado'] ?></span>
					<br><small class="text-muted">CEP: <?= $membro['membro_endereco_cep'] ?></small>
				</p>
			<?php else: ?>
				<p class="text-muted small mb-0 fst-italic text-center py-2">
					<i class="bi bi-info-circle me-1"></i> Nenhum endereço cadastrado para este membro.
				</p>
			<?php endif; ?>
		</div>
	</div>
