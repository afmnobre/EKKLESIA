            ...
            <form action="<?= url('patrimonios/salvar') ?>" method="POST">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="patrimonio_bem_nome" class="form-control shadow-none" placeholder="Ex: Projetor Epson..." required>
                    </div>
                        ...
                        <label class="form-label fw-bold">Categoria</label>
							<select name="patrimonio_bem_categoria_id" class="form-select shadow-none" required>
								...
								<?php foreach($categorias as $c): ?>
									<option value="<?= $c['patrimonio_categoria_id'] ?>">
                ...
                <div class="d-flex justify-content-end mt-4">
                    <button type="submit" class="btn btn-primary px-5 fw-bold">
                        <i class="bi bi-check-lg me-1"></i> SALVAR PATRIMÔNIO
                    </button>
                </div>
            </form>
        </div>
