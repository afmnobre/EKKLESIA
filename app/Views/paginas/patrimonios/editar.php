            ...
            <form action="<?= url('patrimonios/atualizar') ?>" method="POST">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="patrimonio_bem_nome" class="form-control" value="<?= $bem['patrimonio_bem_nome'] ?>" required>
                    </div>

                    <div class="col-md-12 mb-3">
                        <label class="form-label fw-bold">Descrição / Detalhes</label>
                        <textarea name="patrimonio_bem_descricao" class="form-control" rows="3"><?= $bem['patrimonio_bem_descricao'] ?></textarea>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label class="form-label fw-bold">Data de Aquisição</label>
                        <input type="date" name="patrimonio_bem_data_aquisicao" class="form-control" value="<?= $bem['patrimonio_bem_data_aquisicao'] ?>">
                    </div>

                    <div class="col-md-4 mb-3">
                        <label class="form-label fw-bold">Valor (R$)</label>
                        <input type="number" step="0.01" name="patrimonio_bem_valor" class="form-control" value="<?= $bem['patrimonio_bem_valor'] ?>">
                    </div>

                    <div class="col-md-4 mb-3">
                        <label class="form-label fw-bold">Status</label>
                        <select name="patrimonio_bem_status" class="form-select">
                            <?php
