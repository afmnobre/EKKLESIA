...
use App\Models\MobileLancamento;

class MobilelancamentoController extends Controller
{
    private $model;

    public function __construct()
    {
        $this->model = new MobileLancamento();
    }
    ...
    public function index()
    {
        ...
        if (!isset($_SESSION['conf_diacono_1']) || !isset($_SESSION['conf_diacono_2'])) {
            header("Location: " . url('Mobilelancamento/login'));
            exit;
        }
        ...
        // 6. Buscar os rateios dos lançamentos (se tiver)
        ...
        // Linha 51: Ajustado de 'mobilelancamento/index' para 'mobilelancamentos/index'
        return $this->rawview('mobilelancamentos/index', [
            'igreja'           => $igreja,
    ...
    public function login()
    {
        ...
        return $this->rawview('mobilelancamentos/login', [
    ...
    public function autenticarSegundo()
    {
        ...
        if ($oficial2) {
            ...
            echo json_encode([
                'success'  => true,
                'redirect' => url('mobilelancamentos')
            ]);
            exit;
        }
    ...
    public function salvarIndividual()
    {
        ...
        // Define a subcategoria da oferta vinda do POST ou usa o ID padrão
    ...
    public function sair()
    {
        ...
        header("Location: " . url('mobilelancamentos/login'));
    }
    ...
    public function imprimir()
    {
        ...
        $this->rawview('mobilelancamentos/conferencia_impressao', [
            'data'               => $data,
            'igreja'             => $igreja,
    ...
    public function uploadAnexo()
    {
            ...
            if (isset($_FILES['arquivo']) && $_FILES['arquivo']['error'] === 0) {
                ...
                if (move_uploaded_file($_FILES['arquivo']['tmp_name'], $diretorio . $novoNome)) {
                    ...
                    if ($sucesso) {
                        ...
                        header("Location: " . url("mobilelancamentos/index?mes={$mes}&ano={$ano}&sucesso=1"));
                    } else {
        ...
        header("Location: " . url("mobilelancamentos/index?erro=1"));
        exit;
    }
    ...
    public function relatorioContabil()
    {
        ...
        $this->rawview('mobilelancamentos/relatorio_contabil_impressao', [
            'data'        => $dataGeracao,
